	...
	<div class="site-footer-inner container-1280">
		<div class="site-info">
			...
			<?php
				...
				printf( esc_html__( 'Theme: %1$s by %2$s.', 'mediatheme' ), 
									'mediatheme', '<a href="http://www.redbeak.net">Tamás Kertész</a>' );
			?>
		</div><!-- .site-info -->
	</div>
</footer><!-- #colophon -->
...
<script>
	var particleAmount = <?php echo get_theme_mod('particle_num', '15'); ?>;
</script>
<?php wp_footer(); ?>
